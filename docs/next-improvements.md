...
- Live macOS automation exercised the global shortcut, arrows, Return into provider details, paced Tab traversal and Space activation into Trends, and Escape restoring the previous app. Accessible native controls were present. Spoken VoiceOver output and opt-in Notification Center delivery remain manual checks; notification permission was not enabled automatically.
